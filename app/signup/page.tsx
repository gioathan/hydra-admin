        ...
        <div className="bg-white shadow-sm rounded-xl border border-[#E1D7C6]/30 overflow-hidden">
          <div className="p-10 md:p-12">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-[#566572]">Create your free account</p>
            </div>
            ...
            <form onSubmit={handleSubmit(({ website, ...data }) => { if (website) return; mutate(data); })} className="space-y-5" noValidate>
              ...
              <div className="space-y-2">
                <label htmlFor="name" className="block text-xs font-bold tracking-[0.12em] text-[#566572] uppercase">
                  Full Name
                </label>
                <input
                  id="name"
                  ...
                  className={`w-full h-14 px-4 bg-[#F4EDE1] border rounded-lg text-[#22303A] placeholder:text-[#8B95A0] outline-none transition-colors text-base
                    ${errors.name ? "border-red-500 focus:border-red-500" : "border-[#E1D7C6] focus:border-[#C25B3C]"}`}
              ...
              {/* Phone */}
              <div className="space-y-2">
                <label htmlFor="phone" className="block text-xs font-bold tracking-[0.12em] text-[#566572] uppercase">
                  Phone
                </label>
                <input
                  id="phone"
                  ...
                  className={`w-full h-14 px-4 bg-[#F4EDE1] border rounded-lg text-[#22303A] placeholder:text-[#8B95A0] outline-none transition-colors text-base
                    ${errors.phone ? "border-red-500 focus:border-red-500" : "border-[#E1D7C6] focus:border-[#C25B3C]"}`}
              ...
              <div className="space-y-2">
                ...
                {errors.password
                  ...
                  : <p className="text-xs text-[#8B95A0]">10+ chars, uppercase, digit, special character</p>
                }
              </div>
              ...
              <button
                type="submit"
                disabled={anyPending}
                className="w-full h-16 bg-[#C25B3C] text-white font-bold tracking-[0.1em] text-sm rounded-lg hover:bg-[#9E4527] transition-all duration-300 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
              >
            ...
            <div className="mt-10 pt-10 border-t border-[#E1D7C6]/30 text-center">
              <p className="text-[#566572]">
                ...
                <Link href="/signin" className="text-[#C25B3C] font-bold hover:underline ml-1">
                  Sign in
                </Link>
              </p>
            </div>
