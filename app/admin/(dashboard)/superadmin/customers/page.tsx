...
export default function SuperAdminCustomersPage() {
  ...
  return (
    <div className="p-6 lg:p-8 flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-[#1B2B4B]">Customers</h1>
        <p className="text-sm text-[#6B7280] mt-1">All customer accounts</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="text-left text-xs font-semibold text-[#6B7280] uppercase tracking-wide pb-3 pt-4 px-4">Email</th>
              <th className="text-left text-xs font-semibold text-[#6B7280] uppercase tracking-wide pb-3 pt-4 px-4">Phone</th>
              <th className="text-left text-xs font-semibold text-[#6B7280] uppercase tracking-wide pb-3 pt-4 px-4">Locale</th>
              <th className="text-left text-xs font-semibold text-[#6B7280] uppercase tracking-wide pb-3 pt-4 px-4">Joined</th>
            </tr>
          </thead>
          <tbody>
            {isLoading
              ...
              : (data?.items ?? []).map((c) => (
                  <tr key={c.id} className="hover:bg-gray-50">
                    <td className="py-3 border-t border-gray-100 px-6 text-[#1B2B4B] font-medium">{c.name ?? "—"}</td>
                    <td className="py-3 border-t border-gray-100 px-4 text-[#6B7280]">{c.email}</td>
                    <td className="py-3 border-t border-gray-100 px-4 text-[#6B7280]">{c.phone ?? "—"}</td>
                    <td className="py-3 border-t border-gray-100 px-4 text-[#6B7280]">{c.locale ?? "—"}</td>
