  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      >
        ...
        <h1 className="text-lg font-semibold" style={{ color: "#0C5F7D", fontFamily: "var(--font-sans)" }}>Change Password</h1>
      </div>
      ...
      >
        ...
        <h1 className="text-2xl font-bold" style={{ color: "#0C5F7D", fontFamily: "var(--font-serif)" }}>Change Password</h1>
      </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              ...
              <div className="lg:bg-white lg:rounded-xl lg:p-8 lg:border lg:border-gray-100 lg:shadow-sm">
                ...
                >
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs mt-1" style={{ color: "#8B95A0" }}>10+ chars, uppercase, digit, special character</p>
                  </div>
                  <Input
            ...
            <div className="hidden lg:block lg:col-span-5">
              <div className="sticky top-32 p-8 rounded-xl border flex flex-col gap-5" style={{ background: "#F4EDE1", borderColor: "#E1D7C6" }}>
                <h3 className="text-xs font-bold uppercase tracking-widest" style={{ color: "#8B95A0", fontFamily: "var(--font-sans)" }}>Password Requirements</h3>
                ...
                <p className="text-sm leading-relaxed" style={{ color: "#8B95A0" }}>
...
function RequirementItem({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-3">
      <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: "#C25B3C" }}>
        <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
        </svg>
      </div>
      <span className="text-sm" style={{ color: "#0C5F7D" }}>{label}</span>
    </div>
  );
}
