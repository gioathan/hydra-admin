  ...
  return (
    <>
      ...
      <div className="lg:hidden flex flex-col min-h-full items-center justify-center px-4 py-12 text-center">
        <div className="w-20 h-20 rounded-full bg-[#1B2B4B] flex items-center justify-center mb-6">
          <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
          </svg>
        </div>
        <h1 className="text-2xl font-bold text-[#1B2B4B] mb-2">
          {isConfirmed ? "Booking Confirmed!" : "Booking Requested!"}
        </h1>
        <p className="text-sm text-[#44474e] max-w-xs">
          {isConfirmed
        ...
        {bookingId && (
          <div className="mt-6 bg-white border border-gray-100 rounded-2xl px-6 py-4 shadow-sm">
            <p className="text-xs text-[#75777f] uppercase tracking-wider mb-1">Reference</p>
            <p className="text-xl font-mono font-bold text-[#1B2B4B]">#{shortId(bookingId)}</p>
          </div>
        )}
        <div className="flex flex-col gap-3 mt-8 w-full max-w-xs">
          <Link
            href="/reservations"
            className="w-full bg-[#1B2B4B] text-white py-3.5 rounded-xl font-semibold text-sm text-center hover:bg-[#152234] transition-colors"
          >
            Go to Reservations
          </Link>
          <Link
            href="/discover"
            className="w-full border border-gray-200 text-[#1B2B4B] py-3.5 rounded-xl font-semibold text-sm text-center hover:bg-gray-50 transition-colors"
          >
            Back to Discover
          </Link>
        </div>
      ...
      <div className="hidden lg:flex flex-col items-center justify-center flex-1 py-24 px-8" style={{ background: "#fbf9f4" }}>
        <div className="w-full max-w-2xl text-center">
          ...
          <div className="relative inline-block mb-10">
            <div
              ...
              style={{ background: "radial-gradient(circle, rgba(253,142,85,0.12) 0%, rgba(253,142,85,0) 70%)" }}
            />
            <div
              className="relative w-24 h-24 rounded-full flex items-center justify-center shadow-lg"
              style={{ background: "#fd8e55" }}
            >
          ...
          <h1
            ...
            style={{ fontFamily: "var(--font-serif)", color: "#041635", lineHeight: 1.2 }}
          >
            {isConfirmed ? "Booking Confirmed!" : "Booking Requested!"}
          </h1>
          <p
            ...
            <div className="md:w-2/3 p-8 flex flex-col justify-center">
              ...
              <div className="grid grid-cols-2 gap-y-5">
                ...
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" style={{ color: "#75777f" }}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 9v7.5" />
                  </svg>
                  <div>
                    <p className="text-xs uppercase tracking-widest mb-0.5" style={{ color: "#75777f", fontFamily: "var(--font-sans)" }}>Date</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-widest mb-0.5" style={{ color: "#75777f", fontFamily: "var(--font-sans)" }}>Time</p>
                    <p className="text-sm font-semibold" style={{ color: "#041635", fontFamily: "var(--font-sans)" }}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-widest mb-0.5" style={{ color: "#75777f", fontFamily: "var(--font-sans)" }}>Guests</p>
                    <p className="text-sm font-semibold" style={{ color: "#041635", fontFamily: "var(--font-sans)" }}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-widest mb-0.5" style={{ color: "#75777f", fontFamily: "var(--font-sans)" }}>Location</p>
                    <p className="text-sm font-semibold" style={{ color: "#041635", fontFamily: "var(--font-sans)" }}>
          ...
          {/* Reference */}
          {bookingId && (
            <p className="text-xs mb-8" style={{ color: "#75777f", fontFamily: "var(--font-sans)" }}>
              Booking reference: <span className="font-mono font-bold" style={{ color: "#041635" }}>#{shortId(bookingId)}</span>
            </p>
          )}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              href="/discover"
              className="px-10 py-4 text-sm font-bold uppercase tracking-wider rounded-full border transition-all hover:bg-[#f0eee9] active:scale-95 text-center"
              style={{ color: "#041635", borderColor: "#75777f", fontFamily: "var(--font-sans)" }}
            >
              Back to Discover
            </Link>
          </div>
          ...
          {/* Help */}
          <p className="mt-16 text-sm" style={{ color: "#44474e", fontFamily: "var(--font-sans)" }}>
            Need to make a change?{" "}
            <Link href="/reservations" className="font-semibold hover:underline" style={{ color: "#9c440f" }}>
              View your bookings
            </Link>
          </p>
        </div>
