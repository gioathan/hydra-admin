      ...
      <button
        ...
        className={`py-4 rounded-lg text-sm font-semibold border transition-all ${
          isSel
            ...
            : "bg-white hover:border-[#C25B3C] hover:text-[#C25B3C]"
        }`}
        style={
          isSel
    ...
    <div className="flex flex-col min-h-full" style={{ background: "#FAF6EF" }}>
      ...
      <div className="lg:hidden flex flex-col min-h-full">
        <div style={{ padding: "48px 20px 16px", background: "#ffffff", borderBottom: "1px solid rgba(225, 215, 198,0.4)", display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <h1 className="text-lg font-semibold" style={{ color: "#0C5F7D", fontFamily: "var(--font-sans)" }}>Choose a time</h1>
        ...
        <div className="flex-1 px-4 py-5">
          ...
          {isError && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <p className="text-[#566572] text-sm">Could not load slots. Try a different date.</p>
            </div>
          )}

          {slots && slots.length === 0 && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <p className="text-[#566572] text-sm font-medium">No availability</p>
              <p className="text-xs text-[#8B95A0] mt-1">Try a different date or party size.</p>
            </div>
          )}
                ...
                return (
                  <button
                    ...
                    className={`py-3 rounded-xl text-sm font-medium transition-colors border
                      ${isSelected
                        ? "bg-[#C25B3C] text-white border-[#C25B3C]"
                        : "bg-white text-[#0C5F7D] border-gray-200 hover:border-[#C25B3C]"
                      }`}
                  >
        ...
        {selected && (
          <div className="px-4 pb-6 pt-2">
            <button
              ...
              className="w-full bg-[#C25B3C] text-white py-4 rounded-xl font-semibold text-base hover:bg-[#9E4527] transition-colors"
            >
        ...
        <main className="max-w-[1440px] mx-auto w-full px-20 py-16">
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-8 space-y-16">
              ...
              {/* Header */}
              <header className="flex items-end justify-between border-b pb-8" style={{ borderColor: "#E1D7C6" }}>
                <div>
                  <h2
                  ...
                  <p className="text-lg" style={{ color: "#566572", fontFamily: "var(--font-sans)" }}>
                    For {formattedDate}, {partySize} {partySize === 1 ? "Guest" : "Guests"}
                  </p>
                </div>
                <button
                  onClick={() => router.back()}
                  className="flex items-center gap-2 text-sm font-semibold px-4 py-2.5 border rounded-lg transition hover:bg-[#F0E9DD]"
                  style={{ color: "#0C5F7D", borderColor: "#0C5F7D", fontFamily: "var(--font-sans)" }}
                >
              ...
              {isLoading && (
                <div className="grid grid-cols-5 gap-4">
                  {[...Array(10)].map((_, i) => (
                    <div key={i} className="h-14 rounded-lg animate-pulse" style={{ background: "#E6DCCC" }} />
                  ))}
                </div>
              )}
              ...
              {isError && (
                <div className="py-20 text-center">
                  <p style={{ color: "#566572", fontFamily: "var(--font-sans)" }}>
              ...
              {slots && slots.length === 0 && (
                <div className="py-20 text-center">
                  <p className="text-2xl font-semibold mb-2" style={{ fontFamily: "var(--font-serif)", color: "#0C5F7D" }}>
                    No availability
                  </p>
              ...
              {slots && slots.length > 0 && (
                <div
                  ...
                  style={{ background: "#0C5F7D", borderLeftColor: "#C25B3C" }}
                >
                  <svg className="w-8 h-8 shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" style={{ color: "#F6D9CD" }}>
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed" style={{ color: "#7FA7B5", fontFamily: "var(--font-sans)" }}>
              ...
              >
                ...
                <div className="flex flex-col gap-5 mb-10">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-bold text-right max-w-[60%]" style={{ color: "#0C5F7D", fontFamily: "var(--font-sans)" }}>
                      {venue?.name ?? "—"}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm" style={{ color: "#566572", fontFamily: "var(--font-sans)" }}>Date</span>
                    <span className="text-sm font-bold" style={{ color: "#0C5F7D", fontFamily: "var(--font-sans)" }}>{formattedDate}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm" style={{ color: "#566572", fontFamily: "var(--font-sans)" }}>Party Size</span>
                    <span className="text-sm font-bold" style={{ color: "#0C5F7D", fontFamily: "var(--font-sans)" }}>
                      {partySize} {partySize === 1 ? "Guest" : "Guests"}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm" style={{ color: "#566572", fontFamily: "var(--font-sans)" }}>Selected Time</span>
                    <span
                      className="text-3xl font-extrabold"
                      style={{ color: "#C25B3C", fontFamily: "var(--font-serif)" }}
                    >
                  ...
                  <div
                    ...
                    style={{ background: "#F6D9CD", color: "#3A1608" }}
                  >
                ...
                <p className="mt-6 text-center text-xs px-4" style={{ color: "#8B95A0", fontFamily: "var(--font-sans)" }}>
