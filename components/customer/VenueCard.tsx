  ...
  return (
    <Link
      ...
      style={{
        ...
        boxShadow: "0 8px 32px rgba(12, 95, 125,0.08)",
        marginBottom: 0,
      }}
    >
      ...
      <div className="relative overflow-hidden" style={{ height: 256, background: "#ECE3D4" }}>
        {firstPhoto?.photoUrl ? (
          ...
          <div className="w-full h-full flex items-center justify-center" style={{ background: "#0C5F7D" }}>
      ...
      <div className="p-4 flex items-end justify-between gap-3">
        <div className="flex-1 min-w-0 flex flex-col gap-1">
          ...
          <div className="flex items-center gap-1">
            <svg className="w-3.5 h-3.5 shrink-0" style={{ color: "#C25B3C" }} fill="currentColor" viewBox="0 0 20 20">
        ...
        <span
          ...
          style={{
            background: "#C25B3C",
            fontFamily: "var(--font-sans)",
            boxShadow: "0 2px 6px rgba(194, 91, 60,0.35)",
          }}
        >
          Book
        </span>
